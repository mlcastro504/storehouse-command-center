  ...
  static async generateAllMockData(): Promise<boolean> {
    try {
      ...
      const locations = [
        ...
        { _id: 'loc_a1_r1_s1', id: 'loc_a1_r1_s1', code: 'A1-R1-S1', name: 'Aisle 1, Rack 1, Shelf 1', warehouse_id: 'wh_main', type: 'shelf', confirmation_code: 'A1R1S1', occupancy_status: 'available', is_active: true, capacity: 10, current_occupancy: 0, user_id: mainUserId, created_at: now.toISOString(), updated_at: now.toISOString() },
        { _id: 'loc_b2_r1_s1', id: 'loc_b2_r1_s1', code: 'B2-R1-S1', name: 'Aisle B, Rack 2, Shelf 1', warehouse_id: 'wh_main', type: 'shelf', confirmation_code: 'B2R1S1', occupancy_status: 'available', is_active: true, capacity: 10, current_occupancy: 0, user_id: mainUserId, created_at: now.toISOString(), updated_at: now.toISOString() },
        { _id: 'loc_ground_01', id: 'loc_ground_01', code: 'GROUND-01', name: 'Ground Floor Area 1', warehouse_id: 'wh_main', type: 'ground_level', confirmation_code: 'GROUND01', occupancy_status: 'available', is_active: true, capacity: 2, current_occupancy: 0, user_id: mainUserId, created_at: now.toISOString(), updated_at: now.toISOString() },
        { _id: 'loc_cold_a1', id: 'loc_cold_a1', code: 'COLD-A1', name: 'Cold Zone A1', warehouse_id: 'wh_main', type: 'cold_zone', confirmation_code: 'COLDA1', occupancy_status: 'available', is_active: true, capacity: 50, current_occupancy: 0, user_id: mainUserId, created_at: now.toISOString(), updated_at: now.toISOString() },
      ];
